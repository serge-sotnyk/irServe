...
| ORC-013 | routing            | `GET /about` resolves to `about.html`                            | SRV-ROUT-002                            | `cases/prec-cleanurls-default.json#about_no_slash`               | must-match: status=200, content-type `text/html; charset=utf-8`                                  | verified |
