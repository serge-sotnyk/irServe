...
- Probe: `tools/probe/cases/redirects-types.json` (path-segment redirect with default 301), `tools/probe/cases/redirects-glob-source.json` (`*`-source cross-segment, `**`-collapse, multi-`*` minimatch-fallback positive/negative + leading-`.` rejection), `tools/probe/cases/redirects-source-slasher.json` (source-side `path.posix.normalize` parity), `tools/probe/cases/redirects-negation-source.json` (`!`-prefix + `:name` falls through to minimatch), `tools/probe/cases/redirects-pattern-with-multistar-fallback.json` (`:name`+multi-`*` falls to minimatch on literal `:name` paths).
- Oracle test: ORC-030, ORC-084, ORC-085, ORC-089, ORC-090, ORC-091, ORC-092, ORC-093, ORC-094, ORC-095, ORC-096, ORC-097, ORC-098, ORC-099, ORC-100, ORC-101, ORC-102, ORC-103 (snapshots in tools/probe/snapshots/).
