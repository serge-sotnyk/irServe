...
matching `If-None-Match`. Future sub-stages will add
`Last-Modified` + `If-Modified-Since` (Stage 7b),
`Range` / `206` / `416` (Stage 7c), and default `Cache-Control`
(Stage 7d) under the same capability.
