...
- [x] 3.1 `openspec/changes/archive/2026-05-15-004-route-normalization/proposal.md`
- [x] 3.2 `openspec/changes/archive/2026-05-15-004-route-normalization/design.md`
- [x] 3.3 `openspec/changes/archive/2026-05-15-004-route-normalization/tasks.md` (this
  document)
...
- [x] 4.1 `openspec/changes/archive/2026-05-15-004-route-normalization/specs/routing/
...
- [x] 5.9 `openspec/changes/archive/2026-05-15-004-route-normalization/{proposal,design}.md`
  — document the override coupling and URL-decode invariant
- [x] 5.10 `openspec/changes/archive/2026-05-15-004-route-normalization/specs/routing/spec.md`
...
- [x] 6.8 `openspec/changes/archive/2026-05-15-004-route-normalization/{proposal,
  design}.md` — document the `Location` encoding step alongside
  the existing decode and override descriptions
- [x] 6.9 `openspec/changes/archive/2026-05-15-004-route-normalization/specs/routing/
...
- [x] 7.2 `openspec/changes/archive/2026-05-15-004-route-normalization/proposal.md`
