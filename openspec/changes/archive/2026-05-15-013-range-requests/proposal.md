...
from Stage 7a (`openspec/changes/archive/2026-05-15-011-etag-conditional/`) and
Stage 7b (`openspec/changes/archive/2026-05-15-012-last-modified/`): the
...
- **Documentation updates (slice 3, this change package +
  ...
  `openspec/changes/archive/2026-05-15-013-range-requests/` with this proposal +
