...
`openspec/changes/archive/2026-05-15-011-etag-conditional/design.md`; the Stage-7b
foundations (the `Range`-absent guard wrapping BOTH 304 paths)
live in `openspec/changes/archive/2026-05-15-012-last-modified/design.md` — all
