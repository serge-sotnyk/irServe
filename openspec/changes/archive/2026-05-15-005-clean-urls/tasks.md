...
- [x] 3.4 OpenSpec change package
  `openspec/changes/archive/2026-05-15-005-clean-urls/{proposal,design,tasks}.md` +
...
- [x] 6.6 `openspec/changes/archive/2026-05-15-005-clean-urls/specs/routing/spec.md`
...
- [x] 6.7 `openspec/changes/archive/2026-05-15-005-clean-urls/proposal.md` "Out of
