...
- [x] Author `openspec/changes/archive/2026-05-15-015-compression/`:
...
- [x] **P2 — OpenSpec described pre-round-1
  ...
  `openspec/changes/archive/2026-05-15-015-compression/specs/http-compression/spec.md`.
- [x] **P3 — Stale doc references to
  ...
  `openspec/changes/archive/2026-05-15-015-compression/proposal.md`, and
  `openspec/changes/archive/2026-05-15-015-compression/design.md` to
