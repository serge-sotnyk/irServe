...
- [x] 3.13 `openspec/changes/archive/2026-05-15-006-configured-redirects/{proposal,design,tasks}.md`
  — change package authored.
- [x] 3.14 `openspec/changes/archive/2026-05-15-006-configured-redirects/specs/redirects/spec.md`
  — MODIFIED delta extending oracle lists for SRV-RDIR-001/002/003;
  Q-007 note refreshed (closed).
- [x] 3.15 `openspec/changes/archive/2026-05-15-006-configured-redirects/specs/routing/spec.md`
...
- [x] 6.4 **P2 — stale doc references scrubbed.**
  ...
  - `openspec/changes/archive/2026-05-15-006-configured-redirects/design.md` — §7.2
    ...
    discovery.
  - `openspec/changes/archive/2026-05-15-006-configured-redirects/proposal.md` —
...
- [x] 17.1 **P2 — Unicode special-folds divergence not in spec
  ...
  `openspec/changes/archive/2026-05-15-006-configured-redirects/specs/redirects/spec.md`
