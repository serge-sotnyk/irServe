...
in `openspec/changes/archive/2026-05-15-001-port-minimal-static-server/design.md`;
...
`openspec/changes/archive/2026-05-15-011-etag-conditional/design.md` and are
