...
- [x] Author `openspec/changes/archive/2026-05-15-012-last-modified/`:
...
- [x] **P3 — propagate the SRV-CLI-013 / SRV-CACHE-002
  ...
  - `openspec/changes/archive/2026-05-15-012-last-modified/specs/http-cache/spec.md:59`
    (delta) — same.
  - `openspec/changes/archive/2026-05-15-012-last-modified/proposal.md:19,25`
  ...
  - `openspec/changes/archive/2026-05-15-012-last-modified/proposal.md:131`
